    ...
    public static void main(String[] args) {
        ...
        while (n-->0){
            ...
            if (canh1+canh2>canh3 && canh1+canh3>canh2 && canh3+canh2>canh1){
                double cv = Math.sqrt((canh1+canh2+canh3)*(canh1+canh2-canh3)*(canh2+canh3-canh1)*(canh1+canh3-canh2));
                //cv = Double.valueOf(String.format("%.3f", cv));
                cv = (canh1*canh2*canh3)/cv;
                System.out.println(String.format("%.3f", Math.PI*(Math.pow(cv,2))));
            }else{
